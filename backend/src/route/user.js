...
import { userWithId,allUsers, currentUser, logoutUser, registerUser, updatePassword, updateUser ,updateUserPicture} from "../controller/user.js";
...
router.route("/user-with-id").post(verifyJWT, userWithId)
